<template>
  <div>
    <!-- 
            title="添加商品" 弹框的标题，el-dialog是一个组件，给他传名为title的prop
...
export default {
  ...
  methods: {
     ...
     * 获取tree数据
     */
    sendTreeData(val) {  //val为node-data,是由子节点触发sendTreeData事件，回传过来的
      console.log("the tree data have been returned to GoodsDialog", val);
      this.treeData = val;
    },
